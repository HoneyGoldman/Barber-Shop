...
@Component({
  selector: 'app-login-heb-component',
  templateUrl: './login-heb-component.component.html',
  styleUrls: ['./login-heb-component.component.css']
})
export class LoginHebComponentComponent implements OnInit ,AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    if(x!==null){
    x.style.backgroundImage='url(../assets/personIcon.png)'
    ...
    if(y!==null){
    y.style.backgroundImage='url(../assets/lockerIcon.png)'
  ...
  ngOnInit(): void {
    ...
    this.properties.inputStyle = { 'border': '1px solid black', 'background': 'transparent', 'border-radius': '25px'}
    this.properties.buttonClass = ['button', 'buttonBlack']
